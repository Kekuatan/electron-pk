...
$(document).ready(function () {
    ...
    function init_template() {
        ...
        function darkMode() {
            ...
            if (localStorage.getItem('Appkit-Theme') == 'dark-mode') {
                darkSwitch.prop('checked', true);
                $('body').removeClass('theme-light').addClass('theme-dark');
            }
            if (localStorage.getItem('Appkit-Theme') == 'light-mode') {
                darkSwitch.prop('checked', false);
            ...
            function activateNoPreference() {
                $('#manual-mode-detected').removeClass('disabled');
            }
        ...
        $.fn.visited = function (className) {
            ...
            $(this).each(function (index, element) {
                if ((element.host == window.location.host && localStorage.getItem('z_AppKit-Visited:' + element.pathname)) || localStorage.getItem('z_AppKit-Visited:' + element.pathname + '/')) {
                    if (className) {
        ...
        function hide_back_to_top_badge() {
            backToTopBadge.removeClass('back-to-top-visible');
        }
        ...
        function show_scroll_ad() {
            scrollAd.addClass('scroll-ad-visible');
        }
        function hide_scroll_ad() {
            scrollAd.removeClass('scroll-ad-visible');
        }
        ...
        $('.ios-input, .android-input, .classic-input').on('click', function () {
            ...
            if (data.length) {
                data.stop().animate({ height: 'toggle' }, 250);
            }
        });
        ...
        function activate_geolocation() {
            ...
            function geoLocate() {
                ...
                function success(position) {
                    ...
                    $('.location-map')
                        .parent()
                        .after(' <a href=' + mapLinkAddress + ' class="btn btn-full btn-l bg-red-dark rounded-0 font-700 mb-n1">View on Google Maps</a>');
                }
                function error() {
        ...
        function activate_vibration() {
            $('[data-vibrate]').on('click', function () {
                var vibrateTime = $(this).data('vibrate');
                window.navigator.vibrate(vibrateTime);
            });
            $('.start-vibrating').on('click', function () {
                var vibrateTimeInput = $('.vibrate-demo').val();
                window.navigator.vibrate(vibrateTimeInput);
            });
        ...
        $(function () {
            preloadImages.lazyload({ threshold: 500 });
        });
    ...
    if (isDevMode === true) {
        if (!$('.reloader').length) {
            $('body').append('<a href="#" class="reloader" style="opacity:1; position:fixed; background-color:#000; color:#FFF; z-index:9999; bottom:100px; left:50%; margin-left:-70px; border-radius:10px; width:140px; line-height:40px; text-align:center;">Developer Mode</a>');
        }
